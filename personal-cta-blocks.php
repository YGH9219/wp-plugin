 ...
 * Description: 펄스 CTA 버튼, AI 브랜드·본문 이미지, AI Threads 문구 생성·자동 게시를 제공합니다.
 * Version: 0.9.2
...
define( 'PERSONAL_CTA_BLOCKS_VERSION', '0.9.2' );
...
require_once __DIR__ . '/includes/threads-meta.php';
require_once __DIR__ . '/includes/threads-daily.php';
require_once __DIR__ . '/includes/threads-admin.php';
require_once __DIR__ . '/includes/social-thumbnail.php';
require_once __DIR__ . '/includes/inline-images.php';
...
function personal_cta_blocks_github_plugin_information( $result, $action, $args ) {
	...
	return (object) array(
		...
		'requires_php'  => '7.4',
		'sections'      => array(
			'description' => '<p>반응형 펄스 CTA 블록, AI 브랜드·본문 이미지, WordPress 글의 AI Threads 문구 생성을 제공합니다.</p>',
